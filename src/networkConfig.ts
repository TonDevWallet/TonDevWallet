    ...
    static_nodes: {
      ...
      nodes: [
        ...
        },
        {
          ...
          version: -1,
          signature:
            'cmaMrV/9wuaHOOyXYjoxBnckJktJqrQZ2i+YaY3ehIyiL3LkW81OQ91vm8zzsx1kwwadGZNzgq4hI4PCB/U5Dw==',
        },
        {
          '@type': 'dht.node',
          id: {
          ...
          version: -1,
          signature:
            'qORMhem9RyG7wnNYF822YL3EXwEoTO82h2TarFbjd0jikMIGizAdir1JyxSfyKkhHdFKGcLMeoPb2dfMIvQwAA==',
        },
        {
          '@type': 'dht.node',
          id: {
          ...
          version: -1,
          signature:
            'DKyGF2nPRxmerpIHxE5FN1Lod3zvJu728NP0iYc1hpNyPvl5epu+7amjimLy1VdzNqFzTJAoJ/gqPPMkXS/kDw==',
        },
        {
          '@type': 'dht.node',
          id: {
